...
//go:generate minimock -i week/internal/service.NoteService -o note_service_minimock.go -n NoteServiceMock -p mocks
...
type NoteServiceMock struct {
	...
	funcCreate          func(ctx context.Context, indo *model.NoteInfo) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, indo *model.NoteInfo)
...
func (mmCreate *mNoteServiceMockCreate) Expect(ctx context.Context, indo *model.NoteInfo) *mNoteServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &NoteServiceMockCreateParams{ctx, indo}
...
// ExpectIndoParam2 sets up expected param indo for NoteService.Create
func (mmCreate *mNoteServiceMockCreate) ExpectIndoParam2(indo *model.NoteInfo) *mNoteServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("NoteServiceMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.paramPtrs.indo = &indo

	return mmCreate
}

// Inspect accepts an inspector function that has same arguments as the NoteService.Create
func (mmCreate *mNoteServiceMockCreate) Inspect(f func(ctx context.Context, indo *model.NoteInfo)) *mNoteServiceMockCreate {
...
func (mmCreate *mNoteServiceMockCreate) Set(f func(ctx context.Context, indo *model.NoteInfo) (i1 int64, err error)) *NoteServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mNoteServiceMockCreate) When(ctx context.Context, indo *model.NoteInfo) *NoteServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("NoteServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &NoteServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &NoteServiceMockCreateParams{ctx, indo},
	}
...
func (mmCreate *NoteServiceMock) Create(ctx context.Context, indo *model.NoteInfo) (i1 int64, err error) {
	mm_atomic.AddUint64(&mmCreate.beforeCreateCounter, 1)
	defer mm_atomic.AddUint64(&mmCreate.afterCreateCounter, 1)

	if mmCreate.inspectFuncCreate != nil {
		mmCreate.inspectFuncCreate(ctx, indo)
	}

	mm_params := NoteServiceMockCreateParams{ctx, indo}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := NoteServiceMockCreateParams{ctx, indo}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmCreate.t.Errorf("NoteServiceMock.Create got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.indo != nil && !minimock.Equal(*mm_want_ptrs.indo, mm_got.indo) {
				mmCreate.t.Errorf("NoteServiceMock.Create got unexpected parameter indo, want: %#v, got: %#v%s\n", *mm_want_ptrs.indo, mm_got.indo, minimock.Diff(*mm_want_ptrs.indo, mm_got.indo))
			}
	...
	if mmCreate.funcCreate != nil {
		return mmCreate.funcCreate(ctx, indo)
	}
	mmCreate.t.Fatalf("Unexpected call to NoteServiceMock.Create. %v %v", ctx, indo)
	return
}
...
func (m *NoteServiceMock) MinimockCreateInspect() {
	...
	if !m.CreateMock.invocationsDone() && afterCreateCounter > 0 {
		m.t.Errorf("Expected %d calls to NoteServiceMock.Create but found %d calls",
...
func (mmGet *NoteServiceMock) Get(ctx context.Context, id int64) (np1 *model.Note, err error) {
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGet.t.Errorf("NoteServiceMock.Get got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.id != nil && !minimock.Equal(*mm_want_ptrs.id, mm_got.id) {
				mmGet.t.Errorf("NoteServiceMock.Get got unexpected parameter id, want: %#v, got: %#v%s\n", *mm_want_ptrs.id, mm_got.id, minimock.Diff(*mm_want_ptrs.id, mm_got.id))
			}
...
func (m *NoteServiceMock) MinimockGetInspect() {
	...
	if !m.GetMock.invocationsDone() && afterGetCounter > 0 {
		m.t.Errorf("Expected %d calls to NoteServiceMock.Get but found %d calls",
